...
class SubCategoryController extends Controller
{
    ...
    public function AddSubCategory(){
        ...
        return view('admin.addsubcategory', compact('categries'));
    }

    // for StoreSubCategory
    ...
    public function EditSubCategory($id){
        $subcatategory_info = SubCategory::findOrFail($id);
        return view('admin.editsubcategory', compact('subcatategory_info'));
